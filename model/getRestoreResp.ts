...
export class GetRestoreResp {
    ...
    */
    'status'?: GetRestoreResp.StatusEnum;
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "GetRestoreResp.StatusEnum"
        },
        {
            "name": "cluster",
            "baseName": "cluster",
    ...
    static getAttributeTypeMap() {
        return GetRestoreResp.attributeTypeMap;
    }
}

export namespace GetRestoreResp {
