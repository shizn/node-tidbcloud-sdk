...
export class OpenapiTiKVNodeMap {
    /**
    ...
    */
    'status'?: OpenapiTiKVNodeMap.StatusEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "OpenapiTiKVNodeMap.StatusEnum"
        }    ];

    static getAttributeTypeMap() {
        return OpenapiTiKVNodeMap.attributeTypeMap;
    }
}

export namespace OpenapiTiKVNodeMap {
