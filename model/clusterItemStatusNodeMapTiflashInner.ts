...
export class ClusterItemStatusNodeMapTiflashInner {
    /**
    ...
    */
    'status'?: ClusterItemStatusNodeMapTiflashInner.StatusEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "ClusterItemStatusNodeMapTiflashInner.StatusEnum"
        }    ];

    static getAttributeTypeMap() {
        return ClusterItemStatusNodeMapTiflashInner.attributeTypeMap;
    }
}

export namespace ClusterItemStatusNodeMapTiflashInner {
