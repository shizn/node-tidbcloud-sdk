...
export class OpenapiTiFlashNodeMap {
    /**
    ...
    */
    'status'?: OpenapiTiFlashNodeMap.StatusEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "OpenapiTiFlashNodeMap.StatusEnum"
        }    ];

    static getAttributeTypeMap() {
        return OpenapiTiFlashNodeMap.attributeTypeMap;
    }
}

export namespace OpenapiTiFlashNodeMap {
