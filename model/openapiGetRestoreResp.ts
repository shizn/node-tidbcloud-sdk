...
*/
export class OpenapiGetRestoreResp {
    /**
    ...
    */
    'status'?: OpenapiGetRestoreResp.StatusEnum;
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "OpenapiGetRestoreResp.StatusEnum"
        },
        {
            "name": "cluster",
            "baseName": "cluster",
    ...
    static getAttributeTypeMap() {
        return OpenapiGetRestoreResp.attributeTypeMap;
    }
}

export namespace OpenapiGetRestoreResp {
