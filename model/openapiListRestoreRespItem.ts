...
*/
export class OpenapiListRestoreRespItem {
    /**
    ...
    */
    'status'?: OpenapiListRestoreRespItem.StatusEnum;
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "OpenapiListRestoreRespItem.StatusEnum"
        },
        {
            "name": "cluster",
            "baseName": "cluster",
    ...
    static getAttributeTypeMap() {
        return OpenapiListRestoreRespItem.attributeTypeMap;
    }
}

export namespace OpenapiListRestoreRespItem {
