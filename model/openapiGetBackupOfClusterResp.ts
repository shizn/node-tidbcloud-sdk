...
*/
export class OpenapiGetBackupOfClusterResp {
    /**
    ...
    */
    'type'?: OpenapiGetBackupOfClusterResp.TypeEnum;
    /**
    ...
    */
    'status'?: OpenapiGetBackupOfClusterResp.StatusEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "OpenapiGetBackupOfClusterResp.StatusEnum"
        }    ];

    static getAttributeTypeMap() {
        return OpenapiGetBackupOfClusterResp.attributeTypeMap;
    }
}

export namespace OpenapiGetBackupOfClusterResp {
