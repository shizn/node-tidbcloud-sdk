...
export class ClusterItemStatusNodeMapTidbInner {
    /**
    ...
    */
    'status'?: ClusterItemStatusNodeMapTidbInner.StatusEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "ClusterItemStatusNodeMapTidbInner.StatusEnum"
        }    ];

    static getAttributeTypeMap() {
        return ClusterItemStatusNodeMapTidbInner.attributeTypeMap;
    }
}

export namespace ClusterItemStatusNodeMapTidbInner {
